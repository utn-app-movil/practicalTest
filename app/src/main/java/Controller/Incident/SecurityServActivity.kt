...
class SecurityServActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_security_serv)

        etReporter = findViewById(R.id.etReporterSec)
        etLocation = findViewById(R.id.etLocationSec)
        etDescription = findViewById(R.id.etDescriptionSec)
        btnDate = findViewById(R.id.btnDateSec)
        spinnerSeverity = findViewById(R.id.spinnerSeveritySec)
        btnSave = findViewById(R.id.btnSaveSec)
    ...
    private fun saveReport() {
        ...
        val prefs = getSharedPreferences("security_reports", MODE_PRIVATE)
        prefs.edit()
